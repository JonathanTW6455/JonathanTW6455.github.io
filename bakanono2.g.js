...
function doGet(e){
 ...
 if(SPO2==0)
  ...
  if(SPO2>95)
  { 
  userProperties.setProperty('SPO2Text', nowDatetime  + " 您的血氧濃度是 " + SPO2 + " %");
  }
  if(SPO2<95 && SPO2>0)
  {
  userProperties.setProperty('SPO2Text', nowDatetime  + " 您的血氧濃度是 " + SPO2 + " %"+"血氧濃度偏低，請留意身體狀況並盡速就醫");
  }
